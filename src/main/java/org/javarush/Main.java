...
public class Main {
    ...
    public Main () {
        ...
        properties.put(Environment.PASS, "Igor2006@");
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            film.setLength((short) 102);
            film.setReplacementCost(BigDecimal.TEN);
            film.setRentalRate(BigDecimal.ZERO);
            film.setLanguage(language);
            film.setDescription("the best film");
            film.setTitle("Harry Potter and Chubaka");
            ...
            filmText.setDescription("the best film");
            filmText.setTitle("Harry Potter and Chubaka");
    ...
    private Customer createCustomer() {
        try(Session session = sessionFactory.getCurrentSession()){
            ...
            address.setAddress("1st Ave, 55");
            address.setPhone("123-456-789");
            address.setCity(city);
            address.setDistrict("2nd district");
            addressDAO.save(address);

            Customer customer = new Customer();
            customer.setActive(true);
            customer.setEmail("test@vipmail.com");
